...
CREATE TABLE `cms_prefrence_area_product_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优选专区和产品关系表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cms_subject`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '专题表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `oms_cart_item`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '购物车表' ROW_FORMAT = Dynamic;
...
INSERT INTO `oms_cart_item` VALUES (19, 48, NULL, 5, 1, 8499.00, NULL, NULL, NULL, 'http://e-mall.oss-cn-beijing.aliyuncs.com/e-mall/img/20190322/5bfbc0e5N263aeb9c.jpg', '联想(Lenovo)拯救者Y7000P', 'Y7000P英特尔酷睿 i7 15.6英寸高色域游戏笔记本电脑(i7-8750H 8G 512G GTX1060 144Hz)', NULL, 'lisi', '2019-03-23 23:42:48', NULL, 1, 56, NULL, NULL, NULL);
INSERT INTO `oms_cart_item` VALUES (20, 27, NULL, 5, 1, 2699.00, NULL, NULL, NULL, 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180615/xiaomi.jpg', '小米8 全面屏智能手机', '骁龙845处理器，红外人脸解锁，AI变焦双摄，AI语音助手小米6X低至1299，点击抢购', NULL, 'lisi', '2019-03-27 09:40:47', NULL, 1, 19, NULL, NULL, NULL);
INSERT INTO `oms_cart_item` VALUES (21, 36, NULL, 5, 2, 3599.00, NULL, NULL, NULL, 'http://e-mall.oss-cn-beijing.aliyuncs.com/e-mall/img/20190308/1879e5f23c7bef95e_840_840.png', '一加6T', '一加智能手机', NULL, 'lisi', '2019-03-27 09:40:51', NULL, 1, 29, NULL, NULL, NULL);
INSERT INTO `oms_cart_item` VALUES (22, 34, NULL, 5, 1, 3999.00, NULL, NULL, NULL, 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180615/5b028530N51eee7d4.jpg', '小米（MI）小米电视4A 65英寸', ' L65M5-AZ/L65M5-AD 2GB+8GB HDR 4K超高清 人工智能网络液晶平板电视', NULL, 'lisi', '2019-03-27 09:42:17', NULL, 0, 35, NULL, NULL, NULL);
INSERT INTO `oms_cart_item` VALUES (23, 29, NULL, 5, 1, 5499.00, NULL, NULL, NULL, 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180615/5acc5248N6a5f81cd.jpg', 'Apple iPhone 8 Plus 64GB', '【限时限量抢购】Apple产品年中狂欢节，好物尽享，美在智慧！速来 >> 勾选[保障服务][原厂保2年]，获得AppleCare+全方位服务计划，原厂延保售后无忧。', NULL, 'lisi', '2019-03-27 09:42:20', NULL, 1, 19, NULL, NULL, NULL);
INSERT INTO `oms_cart_item` VALUES (24, 48, NULL, 5, 1, 8499.00, NULL, NULL, NULL, 'http://e-mall.oss-cn-beijing.aliyuncs.com/e-mall/img/20190322/5bfbc0e5N263aeb9c.jpg', '联想(Lenovo)拯救者Y7000P', 'Y7000P英特尔酷睿 i7 15.6英寸高色域游戏笔记本电脑(i7-8750H 8G 512G GTX1060 144Hz)', NULL, 'lisi', '2019-03-27 10:05:10', NULL, 1, 56, NULL, NULL, NULL);
INSERT INTO `oms_cart_item` VALUES (25, 45, NULL, 5, 1, 1499.00, NULL, NULL, NULL, 'http://e-mall.oss-cn-beijing.aliyuncs.com/e-mall/img/20190312/5b16369dN3ff71efd.jpg', 'Apple AirPods 蓝牙无线耳机', 'Apple AirPods 蓝牙无线耳机', NULL, 'lisi', '2019-03-27 10:05:14', NULL, 0, 30, NULL, NULL, NULL);
INSERT INTO `oms_cart_item` VALUES (26, 29, NULL, 5, 1, 5499.00, NULL, NULL, NULL, 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180615/5acc5248N6a5f81cd.jpg', 'Apple iPhone 8 Plus 64GB', '【限时限量抢购】Apple产品年中狂欢节，好物尽享，美在智慧！速来 >> 勾选[保障服务][原厂保2年]，获得AppleCare+全方位服务计划，原厂延保售后无忧。', NULL, 'lisi', '2019-03-27 10:05:21', '2019-03-27 10:05:22', 0, 19, NULL, NULL, NULL);
...
CREATE TABLE `oms_order_operate_history`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单操作历史记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_brand`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 71 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '品牌表' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_brand` VALUES (2, '三星', 'S', 100, 1, 1, 100, 100, 'https://e-mall.oss-cn-beijing.aliyuncs.com/brand/20190327104826.png', NULL, '三星的故事');
...
INSERT INTO `pms_brand` VALUES (68, '佳能', 'J', 34, 1, 1, NULL, NULL, 'https://e-mall.oss-cn-beijing.aliyuncs.com/brand/2019032702254676175timg.jpg', '', '');
...
CREATE TABLE `pms_member_price`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 240 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品会员价格表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_attribute`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 82 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品属性参数表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_attribute_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 283 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '存储产品参数信息的表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 63 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品分类' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_category_attribute_relation`  (
  ...
  `product_attribute_id` bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品的分类和属性的关系表，用于设置分类筛选条件（只支持一级分类）' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_full_reduction`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 76 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品满减表(只针对同商品)' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_ladder`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 81 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品阶梯价格表(只针对同商品)' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_sku_stock`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 117 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sku的库存' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_flash_promotion`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '限时购表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_flash_promotion_product_relation`  (
  ...
  `sort` int(11) NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品限时购与商品关系表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_flash_promotion_session`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '限时购场次表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_home_brand`  (
  ...
  `sort` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '首页推荐品牌表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_admin_role_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台用户和角色关系表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ums_member
-- ----------------------------
INSERT INTO `ums_member` VALUES (3, 4, 'windy', 'E10ADC3949BA59ABBE56E057F20F883E', 'windy', '18061581848', 1, '2018-08-03 16:46:38', 'https://e-mall.oss-cn-beijing.aliyuncs.com/img/20140923094045_BNYji.thumb.700_0.png', 0, '2019-03-11', '天津', '程序猿', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (4, 4, 'zhengsan', 'E10ADC3949BA59ABBE56E057F20F883E', 'zhengsan', '18061581847', 1, '2018-11-12 14:12:04', 'https://e-mall.oss-cn-beijing.aliyuncs.com/img/20141020100423_aSJer.thumb.700_0.jpeg', 0, '2019-03-18', '北京', '公务员', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (5, 4, 'lisi', 'e10adc3949ba59abbe56e057f20f883e', 'lisi', '18061581841', 1, '2018-11-12 14:12:38', 'https://e-mall.oss-cn-beijing.aliyuncs.com/img/20141109222431_58P5J.thumb.700_0.png', 0, '2019-03-18', '上海', '项目经理', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (6, 4, 'wangwu', 'E10ADC3949BA59ABBE56E057F20F883E', 'wangwu', '18061581842', 1, '2018-11-12 14:13:09', 'https://e-mall.oss-cn-beijing.aliyuncs.com/img/20150906123059_yJ2eh.thumb.700_0.jpeg', 1, '2019-03-17', '济南', '人事主管', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (7, 4, 'lion', 'E10ADC3949BA59ABBE56E057F20F883E', 'lion', '18061581845', 1, '2018-11-12 14:21:39', 'https://e-mall.oss-cn-beijing.aliyuncs.com/img/20160818132039_54Q2f.thumb.700_0.jpeg', 1, '2019-03-17', '青岛', '项目组长', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (13, NULL, '666', 'E10ADC3949BA59ABBE56E057F20F883E', '454', '43567698987', 1, NULL, 'https://e-mall.oss-cn-beijing.aliyuncs.com/img/20181224222456_gyqxi.jpeg', 0, '2019-03-08', '33', '234', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (14, NULL, 'wanger', 'E10ADC3949BA59ABBE56E057F20F883E', '王二', '16867453472', 1, NULL, 'https://e-mall.oss-cn-beijing.aliyuncs.com/img/e61190ef76c6a7efb7d78d03fefaaf51f3de6625.jpg', 0, '2019-03-08', '南京', '学生', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (15, 4, '100000', '96E79218965EB72C92A549DD5A330112', NULL, '15234567890', 1, NULL, 'https://e-mall.oss-cn-beijing.aliyuncs.com/img/20140923094045_BNYji.thumb.700_0.png', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `ums_permission`  (
  ...
  `sort` int(11) NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台用户权限表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_role_permission_relation`  (
  ...
  `permission_id` bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台用户角色和权限关系表' ROW_FORMAT = Dynamic;
